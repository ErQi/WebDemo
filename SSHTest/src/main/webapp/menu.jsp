                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/cust_list.action"
                    ...
                    <TR>
                        <TD>
                            <TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
                                ...
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/link_add.action"
                                                           target=main>－ 新增联系人</A></TD>
                                </TR>
                                <TR>
                                    <TD class=menuSmall><A class=style2
                                                           href="${pageContext.request.contextPath}/link_list.action"
